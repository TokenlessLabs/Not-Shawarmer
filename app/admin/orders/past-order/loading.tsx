    ...
    <div className="min-h-screen bg-gray-100 p-5 animate-pulse mt-3">
      ...
      <div className="space-y-4 ">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="bg-white shadow rounded-lg p-8 border border-gray-200 flex justify-between items-start"
          >
            ...
            <div className="flex flex-col space-y-2 ">
              <div className="w-25 h-6 bg-green-200 rounded-full" />
              <div className="w-20 h-5 bg-gray-200 rounded mt-8 ml-4"   />
            </div>
          </div>
        ))}
      </div>
